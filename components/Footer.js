                ...
                <div className="max-w-2xl mx-auto">
                    <div className="py-16 flex flex-col items-center md:flex-row md:items-stretch">
                        <div className="mt-12 flex flex-col items-center w-full">
                            ...
                            <Link className="nav-link w-3/4 text-center text-gray-400" href='/'>Home</Link>
                            <Link className="nav-link w-3/4 text-center text-gray-400" href='/contact'>Contact</Link>
                        </div>
                        <div className="mt-12 flex flex-col items-center w-full">
                            <p className="text-white pb-3 font-semibold uppercase">Product</p>
                            <Link className="nav-link w-3/4 text-center text-gray-400" href='/'>Features</Link>
                        </div>
                        <div className="mt-12 flex flex-col items-center w-full">
