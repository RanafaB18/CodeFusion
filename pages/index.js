    ...
    <div className='bg-blackish pt-5 w-full h-full'>
      ...
      <main className='mt-28'>
        <section className='flex flex-col lg:flex-row'>
          ...
          <div href="#document" className='hidden lg:flex lg:justify-center lg:items-center lg:flex-1'>
            <div className='relative cursor-pointer'>
              <Image className='rounded-lg h-auto' src={"/svg-export/logo2.svg"} height={200} width={170} alt="" />
              <Link href='#document' className='cursor-pointer absolute -top-40 -left-52 hover:scale-105 transition duration-300'>
              ...
              <Link href='#code' className='cursor-pointer absolute -bottom-40  hover:scale-105 transition duration-300'>
                <div className='relative'>
              ...
              <Link href='#video' className='cursor-pointer absolute -top-40 -right-36 hover:scale-105 transition duration-300'>
                <div className='relative'>
                  <div className='relative'>
        ...
        <section id='features' className='pt-24 flex flex-col bg-white items-center lg:flex-row lg:items-baseline lg:justify-evenly'>
          ...
          <div id='video' className='max-w-xs mt-24 flex flex-col items-center'>
          ...
          <div id='document' className='max-w-xs mt-24 flex flex-col items-center'>
            <div className='flex px-2 py-2 items-center rounded-full bg-pink-200'>
              <div className='rounded-full bg-white p-2'>
                <Image className='h-auto' src={'/svg-export/file-icon.svg'} height={20} width={20} alt='' />
              </div>
